    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: '我的分析', desc: '查看最新得分、構面落點、歷次趨勢與教練評語。支援 360° 多元視角（限領導力評量）。' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: '如何新增班別成員？', desc: '在班別管理的成員區塊勾選已註冊用戶，或在批量輸入區填入姓名、Email，尚未註冊者列為「待加入」。' },
          { label: '360° 評測角色如何分配？', desc: '由學員自行進入評量時選擇「我在評誰」及「我的角色」，教練目前無法代為指派。' },
        ],
      },
    ],
  },
