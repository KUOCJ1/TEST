  ...
  theme: {
    extend: {
      colors: {
        ...
        ink: {
          // 50 原為 #8a8378（對紙色底只有 3.3:1），Sprint 8 調深到 WCAG AA。
          50: '#706a61',
          100: '#6b5a4d',
          200: '#604f42',
          300: '#554539',
        ...
        brass: {
          ...
          300: '#c7a355',
          400: '#a9752e',
          500: '#84652d', // 原 #8a6a2f，在紙色底 4.46:1 差一點點，Sprint 8 調深到 AA
          600: '#6f5424',
          700: '#584419',
        },
        ...
        slate: {
          ...
          200: '#efe6d4',
          300: '#ddd0ba',
          // 400／500 是全站的三級／次要文字色。原值 #b3a48c／#8a7d68 對白底只有
          // 2.4:1／4.0:1，全站 axe color-contrast 失敗的主因（Sprint 8 稽核）。調深到
          // 在白、紙白、頁面底色、米色提示框上都 ≥4.5:1，並維持 400 < 500 < 600 的
          // 深淺順序，保留文字層次。
          400: '#73695a',
          500: '#685e4f',
          600: '#6b5a4d',
        ...
        // 狀態色只覆寫 600：全站把 text-emerald-600／text-amber-600 當「正向／待加強」
        // 文字色用，Tailwind 預設值對白底只有 3.8:1／3.2:1。
        emerald: { 600: '#047a56' },
        amber: { 600: '#a15804' },
      },
      fontFamily: {
