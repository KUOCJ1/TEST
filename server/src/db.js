...
const COLLECTIONS = ['users', 'submissions', 'assessments', 'groups', 'goals', 'readingList', 'learningResourceClicks', 'systemStatus'];
...
export function createDb(file) {
  ...
  const data = { users: [], submissions: [], assessments: [], groups: [], goals: [], readingList: [], learningResourceClicks: [], systemStatus: [] };
  ...
  const KNOWN_ASSESSMENTS = [
    ...
    { id: 'archetype', name: '識己®性格原型評測', description: '4 組性格光譜、40 題，16 種原創性格原型', enabled: true },
  ];
