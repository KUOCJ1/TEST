...
const COLLECTIONS = ['users', 'submissions', 'assessments', 'groups', 'goals', 'readingList', 'learningResourceClicks'];
...
export function createDb(file) {
  ...
  const data = { users: [], submissions: [], assessments: [], groups: [], goals: [], readingList: [], learningResourceClicks: [] };
